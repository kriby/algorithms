...
class MergeSortTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @param $input
     * @param $output
     * @dataProvider dataProviderTestMergeSort
     */
    public function testMergeSort($input, $output)
    {
        PHPUnit_Framework_Assert::assertEquals($output, MergeSort::sort($input));
    }
    
    public function dataProviderTestMergeSort()
    {
        return [
